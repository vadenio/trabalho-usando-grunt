...
(function (au, k) {
	...
	Q.lang = {
		...
		close: "Fechar",
		errors: {
			single: 'Voc� precisa instalar o plugin <a href="{0}">{1}</a> para visualizar o conte�do.',
			shared: 'Voc� precisa instalar os plugins <a href="{0}">{1}</a> e <a href="{2}">{3}</a>, para visualizar o conte�do.',
			either: 'Voc� precisa instalar o plugin <a href="{0}">{1}</a> ou o plugin <a href="{2}">{3}</a>, para visualizar o conte�do.'
		}
	};
